...
function washingmachine() {
  return (
    <div>
      ...
      <p>There are several different types of washing machines available in the market. Some of the common types of washing machines are:
        Top-Load Washing Machine: This is the most traditional and commonly used type of washing machine. In a top-load washing machine, clothes are loaded from the top, and the machine uses an agitator or impeller to wash the clothes. Top-load washing machines are generally more affordable and have a shorter wash cycle.
